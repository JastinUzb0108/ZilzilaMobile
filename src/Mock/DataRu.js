...
export const page1 = {
    ...
    description: [
        {
            text: ' Kuchli zilzilalar – tabiat hodisalari orasida eng qo‘rqinchlisi bo‘lib, bino va inshootlarga jiddiy zarar etkazish kuchiga ega va 5 balldan katta bo‘lgan silkinish bilan kuzatiladi. Mazkur tabiat hodisasi O‘zbekiston Respublikasining seysmik jihatdan faol hududlarida qayd etiladi. '
        },
        {
            text: ' Faraz qiling, uyda o‘tiribsiz, bexosdan zilzila boshlandi, uy ichidagi chiroqlar, oynali shkaflarning tebranishi karsillashi sizda yanada qo‘rquv bilan vahimani keltirib chiqarib, ko‘chada baqir-chaqirlar eshitila boshlaganda odam o‘zini yo‘qotib qo‘ymasdan to‘g‘ri harakatni amalga oshirishi lozim.'
        },
        {
            text: ' Yer silkinishi ro‘y berganda odamlarda paydo bo‘lgan qo‘rquv va vahima uning hayoti uchun xavfli bo‘lgan harakatlarga olib kelishi mumkin. Seysmik faol hududlarda doimiy yashaydigan yoki vaqtincha u yerda xizmat yoki yumush bilan bo‘lib turgan fuqarolar yer silkinganda oddiy ehtiyotkorlik va xavfsizlik choralarini oldindan bilishlari va  amalda ularni qo‘llay olishlari  kerak. '
        },
        {
    ...
    description: [
        {
            ...
            descContext: [
                {
                    text: 'Ta’lim-tarbiya beruvchilar, shu jumladan ishchi xizmatchilari, ta’lim-tarbiya oluvchilar kuchli zilzila vaqtida to‘g‘ri harakatlanishga oldindan tayyorlash bo‘lishlari; '
                },
                {
                    text: 'Xonalarda yuzaga keladigan kuchli zilzilaning birlamchi va ikkilamchi oqibatlari to‘g‘risida zarur bilimga ega bo‘lishlari, bunday vaziyatlarda amaliy harakatlanish tartibini mutaxassislar yordamida yoki mustaqil ravishda o‘zlashtirishlari;  '
                },
                {
                    text: 'Xonalardagi shkaf, kitob javonlarini devorlarga mahkamlab (qotirib) qo‘yish, jihozlarni yiqilmaydigan holatda, eshik va chiqish yo‘llarini to‘sib qo‘ymaydigan qilib joylashtirish; '
                },
                {
                    text: 'Xonalardagi javonlar, shkaflar ustidagi og‘ir buyumlar qattiq mahkamlab qo‘yilishi yoki odam ustiga tushib ketishi mumkin bo‘lgan buyumlar pastga yoki ishonchli joyga joylashtirilishi; '
                },
                {
                    text: 'Xonalardagi dam olish o‘rinlari  derazadan, katta oynalardan, tushib ketishi mumkin bo‘lgan buyumlardan uzoqroq joylashtirilishi; '
                },
                {
                    text: 'Laboratoriya xonalaridagi inson hayoti uchun xavfli bo‘lgan suyuqliklarning idishlari sinib ketishini oldini olish, tushib ketishi yoki to‘kilib ketish xavfini oldinda kamaytirish choralarini ko‘rilishi; '
                },
                {
                    text: 'Birinchi qavatdagilar zilzila sodir bo‘lgan vaqtda ochiq, xavfsiz joyga chiqib ketish yo‘llarini oldindan rejalashtirishlari, buning uchun muassasa atrofidagi binolar joylashuvini yodda saqlab qolishlari;  '
                },

                {
                    text: 'Kuchli zilzila davrida yashash, o‘qish yoki ish joylariga eng yaqin bo‘lgan bo‘lgan evakuatsiya qilinadigan joylarni soha mutaxassislari orqali aniqlashtirib, oldindan bilishlari; '
                },
        ...
        },
        {
            ...
            descContext: [
                {
                    text: 'Sohada faoliyat olib borayotgan xodimlar kuchli zilzila vaqtida to‘g‘ri harakatlanishga oldindan tayyor bo‘lishlari; '
                },
                {
                    text: 'Ish joylarida kuchli zilzilaning birlamchi va ikkilamchi oqibatlari to‘g‘risida zarur bilimga ega bo‘lishlari, bunday vaziyatlarda amaliy harakatlanish tartibini mutaxassislar yordamida yoki mustaqil ravishda o‘zlashtirishlari;  '
                },
                {
                    text: 'Tez alangalanuvchi va o‘yuvchi suyuqliklar solingan idishlarni yer qimirlab, bino silkinganda tushib ketib, portlab yoki yonib ketmaydigan xavfsiz joyda saqlashlari; '
                },
                {
                    text: 'Aloqa vositalarining ishlashida uzilishlar bo‘lgan hollarda, ayniqsa, bolalarning xarakatlari bilan  bog‘liq xatti-harakatlar va kelishilgan harakatlar bo‘yicha boshqa oila a’zolari bilan kelish;  '
                },
                {
                    text: 'Ish joylarida uyali telefonlarni zaryadlangan holda saqlash, uch kunga mo‘ljallangan suv, oziq-ovqat va dori-darmonlar zahirasini yaratish, shuningdek, ko‘chma radio, elektr chiroq, ular uchun batareykalar, shamlarni olib qo‘yish; '
                },
                {
        ...
        },
        {
            ...
            descContext: [
                {
                    text: 'Xonadonlarda oila a’zolari va bolalarga ichki xonalarning xavfsiz joylarini egallashlari, kuchli zilziladan jabrlanganda birinchi yordam ko‘rsatishni o‘rganish; '
                },
                {
                    text: 'Oila a’zolari o‘z xonadonlarida, podyezdda, uydagi  gaz, elektr, suvni o‘chirish yo‘llarini bilish; '
                },
                {
                    text: 'Jismoniy imkoniyati cheklangan shaxslarning seysmik xavfsizligini ta’minlash yo‘llari masul shaxslar tomonidan oldindan ishlab chiqilishi, ini oldindan o‘ylab qo‘yish, rejalashtirish;  '
                },
                {
                    text: 'Birinchi qavatda istiqomat qiluvchilar, zilzila vaqtida binodan chiqish yo‘llarini oldindan belgilab qo‘yishlari;  '
                },
                {
                    text: 'Xonadondagi eng xavfli (ichki va tashqi deraza ostilari, devorlarning oyna bilan qoplangan qismlari, ayniqsa oxirgi  qavatlardagi burchakda joylashgan xonalar,  lift va zinapoya maydonchalari) va xavfsiz joylarni (xonaning asosiy devorlari orasidagi burchagi, ichki eshiklar o‘rni, stol, karavot osti) zilzila vaqtida egallashni o‘rganishlari; '
                },
                {
                    text: 'Javonlarni dam olish o‘rinlaridan, xonaga kirish eshigidan, rakovina va unitazlardan uzoqroq  joyga o‘rnatishlari; '
                },
                {
                    text: 'Kuchli zilziladan jarohatlanganda birinchi yordam ko‘rsatish choralarini o‘rganish, doimo xonadonda dori-darmonlar, birinchi yordam ko‘rsatish qutichasini saqlashlari;  '
                },
                {
                    text: 'Individual ravishda quriladigan uylarni zilzilabardosh qilib qurishga alohida ahamiyat qaratish, uy holatini muntazam o‘rganib borish, uni seysmiy mustahkamlash chorasini ko‘rishlari;  '
                },
                {
                    text: 'Tog‘li va tog‘ oldi hududlarda istiqomat qiluvchilar kuchli zilzilaning ikkilamchi oqibatida yuzaga keladigan xavfli jarayonlar, shu jumladan transchegaraviy sel kelishi va suv bosishlari, eski ko‘chki uchastkalari faollashuvidan muxofazalanish choralarini oldindan amalga oshirishlari; '
                },
                {
                    text: 'Xonadonlarda, mehribonlik uylarida uch kunga mo‘ljallangan suv, oziq-ovqat va dori-darmonlar zahirasi, shuningdek ko‘chma radio, elektr chiroq, ular uchun batareykalar, shamlarni olib qo‘yishlari;  '
                },
                {
        ...
        },
        {
            ...
            descContext: [
                {
                    text: 'Sayohat yoki tashrif davomida, ularga xizmat ko‘rsatuvchi jismoniy va yuridik shaxslar tomonidan mamlakat hududining seysmikligi, tuman va shaharlarning zilzilaga moyil zonada joylashganligi, sezilarli va kuchli zilzilalar ehtimolidan xoli emasligi to‘g‘risida birlamchi ma’lumot berishlari; '
                },
                {
                    text: 'Kuchli zi lzila bilan bog‘liq holda yuzaga kelishi mumkin favqulodda vaziyatlarning birlamchi va ikkilamchi oqibatlari to‘g‘risida, bunday vaziyatlarda to‘g‘ri harakat qilish bo‘yicha suhbatlar o‘tkazish; '
                },
                {
                    text: 'zilziladan oldin, zilzila vaqtida va zilziladan keyin to‘g‘ri harkat qilish tartibi to‘g‘risida elektron buklet va eslatmalar joylashgan veb-platformalar orqali mustaqil bilim olishlarini tashkil etish;  '
                },
                {
...
export const page3 = {
    ...
    description: [
        {
            ...
            descContext: [
                {
                    text: 'Har qanday binoning oynaband devorlaridan uzoqroqda, asosiy devori yonida turishga harakat qilish, oyna to‘siqlardan ehtiyot bo‘lishlari; '
                },
                {
                    text: 'Ikkinchi va undan yuqori qavatlarda bo‘lganda, zinhor derazadan pastga sakramaslik, chunki zilzila binoga jiddiy zarar yetkazmasa ham, sakraganda olinadigan jarohatlanishdan saqlanishni bilishlari; '
                },
                {
                    text: 'Odamlar bilan gavjum joylarda sarosimaga tushmaslik, binoning asosiy devorlariga, ustunlarga yaqinroq osilib turgan buyumlardan, qandil, shamollatgich, reklama taxtalardan uzoqroq turish; '
                },
                {
                    text: 'O‘zini xotirjam tutish, atrofdagilarni sarosima tushiradigan harakatlar qilmaslik, eshik va yo‘laklarda tirbandlik hosil qilmaslik; '
                },
                {
                    text: 'Bino bo‘ylab uning tagida yugurmaslik, binoga kirmaslik, yuqoridan tushishi mumkin bo‘lgan narsalar hayot uchun xavfliligini unutmaslik; '
                },
                {
        ...
        },
        {
            ...
            descContext: [
                {
                    text: 'Xona yoki inshoot ichida bo‘lganda, oldindan belgilab olingan xavfsiz joyga turib olishlari;  '
                },
                {
                    text: 'Yuqoridan suvoq parchalari, yoritgich asboblari, oyna siniqlari tushishi mumkinligini inobatga olib stol yoki krovatlar tagiga berkinib olish; '
                },
                {
                    text: 'Xonalarda mustahkam stollarning tagiga kirib, oynaga teskari o‘girilib, boshlari va yuzlarini qo‘llari bilan berkitib olish; '
                },
                {
                    text: 'Ko‘p qavatli imoratlarning birinchi qavatidan yuqorida bo‘lganda, hech qachon lift yoki zinapoyalarga qarab yugurmaslik, undan foydalanmaslik; '
                },
                {
                    text: 'Odamlar bilan gavjum joylarda (do‘kon, kinoteatr, vokzal) sarosimaga tushmaslik, binoning asosiy devorlariga, ustunlarga yaqinroq osilib turgan buyumlardan, qandil, shamollatgich, reklama taxtalardan uzoqroq turish; '
                },
                {
                    text: 'Shaharda yashirinish uchun yer osti panagohlaridan, ochiq maydonlardan foydalanish, baland binolarining oynali devorlaridan masofa saqlash, tushayotgan narsalardan ehtiyot bo‘lish; '
                },
                {
                    text: 'Poyezdda bo‘lganda, zilzila to‘xtaguniga qadar metro, temir yo‘l xodimlaridan ruxsat olmaguncha joyida qolish; '
                },
                {
                    text: 'Bino ichida bo‘lganda, ularni to‘sib qo‘ymaslik uchun kirish eshiklarini  ochib qo‘yish; '
                },
                {
        ...
        },
        {
            ...
            descContext: [
                {
                    text: 'Ko‘p qavatli uylarning birinchi qavatida yoki individual uylarda istiqomat qiluvchilar, yer qimirlash boshlanishi bilan 15-20 soniya ichida darhol uyning ichidan tashqariga chiqib ketishlari; '
                },
                {
                    text: 'Elektr simlari, gaz quvurlari va baland imoratlar yoki qulab tushish xavfi mavjud obyektlar tagidan uzoqroqqa ochiq joyga o‘tishlari; '
                },
                {
                    text: 'Tog‘ oldi va tog‘li hududlarda sel yoki suv toshish xavfi yuzaga kelganda tepaliklarga yoki suv bosmaydigan, yuqoriroq joyga chiqib olishga yoki tik tog‘ yonbag‘irlari ostidan uzoqroq joylarga o‘tishga harakat qilish; '
                },
                {
        ...
        },
        {
            ...
            descContext: [
                {
                    text: 'Ko‘p qavatli bino ostida turganda, ochiq joyga chiqishga harakat qilish, bino silkinishi natijasida siniq parchalari tushishidan saqlanishlari; '
                },
                {
                    text: 'Ikkinchi va undan yuqori qavatlarda bo‘lganda, zinhor derazadan pastga sakramaslik, chunki zilzila binoga jiddiy zarar yetkazmasa ham, sakraganda olinadigan jarohatlanishdan saqlanishni bilishlari; '
                },
                {
                    text: 'Elektr simlari tagida turmaslik, uzilib ketgan simlardan ehtiyot bo‘lishlari; '
                },
                {
    ...
    desc2: [
        { text: 'Zilzila ro‘y berganda, yerning yuza qismi uncha uzoq  bo‘lmagan vaqt tebranib turadi. Yer silkinish davri – silkinish yer qatlamining yuzasida va yaqin masofada lokal ahamiyatga ega bo‘lsa bir necha soniya, chuqurroq va olisda transchegaraviy ahamiyatga bo‘lsa 1-2 daqiqagacha davom etishi mumkin. Bu tebranishlar insonga noqulaylik tug‘dirib, qo‘rquvga va vahimaga tushiradi. Bunday vaziyatda eng avvalo oldindan belgilangan xavfsiz joylarni egallash va zilzilaning to‘xtashini kutish tavsiya etiladi.  ' },
        {
...
export const page4 = {
    ...
    description: [
        {
            ...
            descContext: [
                {
                    text: 'Zilzila to‘xtagandan keyin binolarning holatini kuzatish, ta’lim-tarbiya oluvchilar o‘z hayotlariga xavf solishi mumkin bo‘lgan narsalardan saqlanishlari;   '
                },
                {
                    text: 'Kuchli zilziladan jabrlanganlarni kuzatish va aniqlash, xotirjamlik bilan darhol shikastlangan, jarohatlanganlarga birinchi yordam ko‘rsatish yoki tez tibbiy yordamni chaqirish; '
                },
                {
                    text: 'Yengil buyumlar ostida qolganlarga yordam berish, qo‘shimcha tibbiy yoki boshqa yordamga ehtiyoj bo‘lsa yordam kelgunicha kutish; '
                },
                {
                    text: 'Vayronalar ostida qolib ketganlarni ko‘rganda yoki ularning qandaydir chaqirig‘ini eshitganda o‘sha joyni aniq eslab qolish va qutqaruvchilarga xabar berish; '
                },
                {
        ...
        },
        {
            ...
            descContext: [
                {
                    text: 'Jabrlanganlarga birinchi yordam ko‘rsatish, qo‘shimcha tibbiy yoki boshqa yordamga ehtiyoj bo‘lsa yordam kelgunicha kutish; '
                },
                {
                    text: 'Vayronalar ostida qolib ketganlarni ko‘rganda yoki ularning qandaydir chaqirig‘ini eshitganda o‘sha joyni aniq eslab qolish va qutqaruvchilarga xabar berish; '
                },
                {
                    text: 'Yerto‘la eshiklarini ochishda ehtiyot bo‘lish, tomdan va tashqi devorlardan ustingizga suvoq parchalari, ustunlar yoki og‘ir jismlar tushishidan ehtiyot bo‘lishlari; '
                },
                {
                    text: 'Zilzila to‘xtagandan keyin binolarning holatini kuzatish, hayotlariga xavf solishi mumkin bo‘lgan narsalardan saqlanishlari; '
                },
                {
                    text: 'Telefonni keraksiz axborotlar uchun band qilib turmaslik, aksincha undan yordamga chaqirish, muhim hodisalar, yaradorlar va jinoyatchilar haqida axborot berishda foydalanish; '
                },
                {
                    text: 'Yong‘in yoki boshqa sabablarga ko‘ra xonada qolmaslik, xonadan chiqish, oldindan tayyorlangan narsalar va mahsulotlarni olib qo‘yish tavsiya etiladi. '
                },
            ],
            youtube: 'LxmcI1qe14c'
        },
        {
            descTitle: '4.3. Ishlab chiqarish va xizmat ko‘rsatish sohasida band bo‘lmaganlarni mahalla va qishloqlarda, shu jumladan jismoniy imkoniyati cheklangan shaxslar mavjud tashkilotlarda: ',
            descContext: [
                {
                    text: 'Jabrlanganlarga birinchi yordam ko‘rsatish, qo‘shimcha tibbiy yoki boshqa yordamga ehtiyoj bo‘lsa yordam kelgunicha kutish; '
                },
                ...
                {
                    text: 'Kasallar, bolalar va qariyalar, shuningdek jismoniy imkoniyati cheklangan shaxslar xavfsizligini ta’minlash, ruhiy dalda berish; '
                },
                {
                    text: 'Zilzila to‘xtagandan keyin binolarning holatini kuzatish, hayotlariga xavf solishi mumkin bo‘lgan narsalardan saqlanishlari; '
                },
                {
                    text: 'Zilzilaning takrorlanishi mumkinligi haqidagi mish-mishlarga ishonmaslik yoki tasdiqlnmagan ma’lumotlarni tarqatmaslik, rasman e’lon qilingan axborotlardan foydalanish; '
                },
                {
                    text: 'Odamlar vayrona ostida qolgan bo‘lsa, iloji boricha xotirjamlik bilan sharoitni to‘g‘ri baholash, o‘ziga birinchi yordam ko‘rsatish, agar lozim bo‘lsa qon oqishini to‘xtatish va jarohatni bog‘lash tavsiya etiladi. '
                },
            ],
            youtube: 'pL6qLwyxSaY'
        },
        {
            descTitle: '4.4. Sayyohlik agentliklarida yoki xorijdan fuqarolar jalb etilgan idora va tashkilotlarda: ',
            descContext: [
                {
                    text: 'Jabrlanganlarga birinchi yordam ko‘rsatish, qo‘shimcha tibbiy yoki boshqa yordamga ehtiyoj bo‘lsa yordam kelgunicha kutish; '
                },
                ...
                {
                    text: 'Vayronalardan tashqaridagilar bilan tovush orqali yoki biror narsani taqillatish bilan aloqa o‘rnatishga harakat qilish, kuchlarni tejash;  '
                },
                {
                    text: 'Agarda vayrona ostida qolgan bo‘lsa, iloji boricha xotirjamlik bilan sharoitni to‘g‘ri baholash, o‘ziga birinchi yordam ko‘rsatish; '
                },
                {
                    text: 'Zilzila to‘xtagandan keyin binolarning holatini kuzatish, hayotlariga xavf solishi mumkin bo‘lgan narsalardan saqlanishlari; '
                },
                {
                    text: 'Ro‘yxatdan o‘tgan chet el fuqarolari, ularning holati to‘g‘risida maksimal ma’lumotlarni to‘plash tavsiya etiladi.  '
                }
            ],
            youtube: 'LBp-oFoCclU'
        },
        {
            descTitle: '4.5. Kuchli zilziladan keyin jabrlanganlarga birinchi yordam ko‘rsatish ',
            descContext: [
                {
                    text: 'Kuchli zilzila oqibatida jabrlangan odamning ahvoli qisqa vaqt ichida og‘irlashib qolishi va hatto vafot etishi mumkin. Bunday hollarda tibbiy xodimlar yoki qutqaruvchilar yetib kelguniga qadar jabrlangan odamga yordam berish, uning holatini yaxshilashga harakat qilish lozim. Bunday harakatlarga birinchi yordam deyiladi. Birinchi yordam – bu jabrlanganlarning hayotini saqlab qolishga, sog‘lig‘i yomonlashib ketishining oldini olishga qaratilgan oddiy chora-tadbirlar majmui. Birinchi yordamni tibbiy xodim bo‘lmagan, ya’ni ma’lumotidan, yoshidan qat’iy nazar fuqarolar tomonidan ko‘rsatiladi.  '
                },
                {
                    text: 'Ko‘p hollarda kuchli zilzilalardan so‘ng, jabrlanganlarga zudlik bilan, imkon darajasida qisqa vaqt (bir necha daqiqa) ichida yordam ko‘rsatish lozim bo‘ladi. Bunday holatlarga yurak yoki nafas olish faoliyatining to‘xtashi, kuchli qon ketishi, xushidan ketishi, turli  shikastlanishlar va boshqalar kiradi. '
                },
                {
                    text: 'Jabrlanganlarni vayronalar ostidan ehtiyot choralari ko‘rib ozod qilish kerak. '
                },
                {
                    text: 'Birinchi yordam ko‘rsatishni boshlashdan oldin, jabrlanganlar birlamchi ko‘rikdan o‘tkazilishi lozim. Birlamchi ko‘rik jabrlangan hushida yoki yo‘qligini hamda uning hayotiga xavf soluvchi omillarni, ya’ni, nafas olishi va yurak urishini tekshirishdan iborat bo‘ladi. '
                },
                {
                    text: 'Nafas olishni aniqlash maqsadida kiyimlardan (rumol, sharf, galstuk) bo‘yin va ko‘krakning yuqori qismi bo‘shatiladi. '
                },
                {
                    text: 'Bir vaqtning o‘zida yurak urishini aniqlanadi. Buning uchun ko‘rsatkich va o‘rta barmoqlarimizni bo‘yin (kekirdak) chetiga qo‘yib, tomir urishini – pulsni tekshiramiz. Puls – arteriya qon tomirini urishi hisoblanadi. '
                }
            ]
        }
    ],
    tableData: [
        [
            ...
            {
                title: 'Kattalar  1 daqiqada '
            },
            {
                title: '8 yoshli bolalar 1 daqiqada'
            },
            {
                title: 'Chaqaloq  1 daqiqada'
            },
        ],
        [
            {
    ...
    infoHead: [
        {
            title: 'Su’niy nafas berish tartibi.',
            descTitle: [
                {
                    text: 'Bosh holatini o‘zgartirmasdan bir kaftni jabrlanganning peshonasiga qo‘yib, shu qo‘lning katta va ko‘rsatkichi bilan burun qanotlarini qisish, ikkinchi qo‘l bilan jabrlanuvchining og‘ziga doka, niqob, ro‘molcha qo‘yish, keyin pastki jag‘ni ushlab turgan holda puflash kerak. Puflash jarayonida ko‘krak qafasining ko‘tarilishini kuzatib turish zarur. Puflash har 5 soniyada (sekundda) bir marta amalga oshiriladi. Vaqti-vaqti bilan tomir urishi tekshirib turiladi. Sun’iy nafas berish nafas tiklangunga, “tez yordam” yoki qutqaruvchilar yetib kelganga qadar davom ettiriladi. '
                },
                {
                    text: 'Yurak faoliyati to‘xtagan (tomir urmayotgan) bo‘lsa, darhol su’niy nafas berish va yurakni bilvosita(yopiq)massaj qilishga o‘tiladi, ya’ni 2 marta nafas berib, 30 marta yurak massaj qilinadi. '
                },
                {
                    text: 'Yurakni massaj qilish jarayonida jabrlangan shaxsni  qattiq va tekis joyga yotqizilib, oyoqlari ko‘tarib qo‘yiladi. Kaftlar to‘sh suyagining pastroq qismiga, (to‘sh suyagi uch qismga bo‘linganda, uning o‘rta bo‘lagi bilan pastki bo‘lagi chegarasiga – bosish markaziga) qo‘yilib, jabrlanuvchining gavda tuzilishidan kelib chiqib 4-5 sm chuqurlikda 30 marotaba bosamiz. So‘ng tomi urishi tekshirib ko‘riladi. Agar tomir urishi aniqlanmasa muolaja davom ettiriladi. Agar tomir urishi paydo bo‘lsa - faqat su’niy nafas berish davom ettiriladi.  '
                },
                {
                    text: 'Jabrlanganga su’niy nafas berish va yurakni yopiq massaj qilish -o‘pka-yurak reanimatsiyasi deb ataladi. '
                },
            ]
        },
        {
            title: 'HUSHDAN KETISH (SINKOPAL HOLAT)',
            descTitle: [
                {
                    text: '– bosh miyada qon aylanishining qisqa vaqtga buzilishi natijasida uning kislorod bilan ta’minlanishi izdan chiqqan holat. Sabablari – jismoniy va ruhiy zo‘riqish, stress holatlari, kuchli qo‘rquv yoki hayajon, surunkali kasallik. '
                }
            ]
        },
        {
            ...
            descTitle: [
                {
                    text: 'Qisqa vaqt – bir necha soniyadan to 2-3 daqiqagacha davom etadigan, bosh aylanishi, o‘zini yomon his qilish, quloqlarning shang‘illashi, ko‘z oldining qorong‘ilashishi, kuchli holsizlik kuzatiladi. Nafas olishi yuzakilashadi, ba’zi hollarda yurak urish (puls) tezligi kamayadi, qon bosimi pasayadi, mushaklarda quvvatsizlik kuzatiladi. '
                }
            ]
        },
        {
            ...
            descTitle: [
                {
                    text: 'jabrlanganni yotqizilib, boshi chap yoki o‘ng tomonga bukiladi va nafas olishi kuzatib turiladi, oyoqlari ko‘tarib qo‘yiladi. O‘tkir hidli (novshadil spirti (nashatir, ammiakning suvli eritmasi), uksus, atseton) hidlatish yoki chakkasiga surtish, sovuq suv purkash yoki yuziga yengil urish tavsiya etiladi. '
                },
                {
                    text: 'Agar 3-5 daqiqada hushiga kelmasa - uni yonboshlatib yotqizib, boshiga sovuq narsa qo‘yib,  zudlikda tibbiy muassasaga olib borish chorasi ko‘riladi. '
                },
                {
                    text: 'Tibbiy xodimlar kelgunga qadar – jabrlanganning nafas olishi va yurak urishi nazorat qilib turiladi. Mabodo nafas olishi to‘xtab qolsa -su’niy berish, agarda yurak faoliyati to‘xtab qolsa - yurakni su’niy yopiq massaj qilish usullari qo‘llaniladi. '
                },
            ]
        },
    ],
    smalData: [
        {
            text: 'Agar jabrlanganning yuragi urib turgani holda nafas olmayotgan bo‘lsa – uni yonboshlatib, nafas yo‘llarini yot jism va suyuqliklardan tozalanadi. Agar nafas tiklansa jabrlangan shu holatda qoladi.'
        },
        {
            text: 'Agar nafas tiklanmasa jabrlanuvchini chalqancha yotqizib, boshi orqa tarafga bukiladi. Shunda ham nafas olish tiklanmasa darhol sun’iy nafas berishga kirishiladi.'
        },
        {
...
export const mainContext = {
    ...
    testContext: {
        quesiton: 'Количество вопросов',
        correct: 'Правилъные ответы',
        buttunText: 'Повторный'
    },
    settings: {
        languageContext: 'Выбратъ язык',
        themeContext: 'Выберите режим темы',
        data: [
            {
                name: 'uzb',
                title: 'Узбек'
